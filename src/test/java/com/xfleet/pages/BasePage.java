...
public abstract class  BasePage {
    ...
    @FindBy(css ="[class='title title-level-2']")
    public WebElement AccountsPages;
    @FindBy(css = "[class='\"fa-cog hide-text\"']")
    public WebElement GridButton;
    @FindBy(css= "[class='column-manager-title']")
...
//            BrowserUtils.waitForStaleElement(Driver.get().findElement(By.xpath(moduleLocator)));
    ...
    public void clickAddButton(String num){

        Driver.get().findElement(By.xpath("(//td[@class='widget-picker-add-btn-wrapper']//a)["+num+"]")).click();
    }

    public String getTextAdd(String num){

        return Driver.get().findElement(By.xpath("(//span[@class='added'])["+num+"]")).getText();
    }
